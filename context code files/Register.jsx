...
// const ROLES = [
//   { value: 'woman', emoji: '👩', label: 'I need safety support', desc: 'Send SOS alerts to nearby volunteers' },
//   { value: 'volunteer', emoji: '🤝', label: 'I want to help', desc: 'Respond to nearby SOS alerts' },
// ];
...
//       return toast.error('Password needs uppercase, lowercase & number');
//     setLoading(true);
//     try {
//       const user = await register(form);
//       toast.success(`Welcome to SafeReach, ${user.name.split(' ')[0]}! 🛡️`);
...
//           <div className={`w-8 h-1.5 rounded-full ${step >= 1 ? 'bg-primary' : 'bg-gray-200'}`} />
//           <div className={`w-8 h-1.5 rounded-full ${step >= 2 ? 'bg-primary' : 'bg-gray-200'}`} />
//         </div>
//       </div>
...
//                 <input name="name" value={form.name} onChange={handleChange} placeholder="Priya Sharma" className="input-field" />
//               </div>
//               <div>
...
//                   <span className="input-field w-14 text-center text-gray-500 flex-shrink-0">+91</span>
//                   <input name="phone" type="tel" value={form.phone} onChange={handleChange} placeholder="9876543210" maxLength={10} className="input-field flex-1" />
//                 </div>
//               </div>
//               <button onClick={nextStep} className="btn-primary w-full mt-2">Continue →</button>
//             </div>
//           )}

//           {step === 2 && (
//             <form onSubmit={handleSubmit} className="space-y-4">
//               <h2 className="text-base font-semibold text-gray-900">Choose your role</h2>
...
//                       </div>
//                       <div className={`ml-auto w-5 h-5 rounded-full border-2 flex items-center justify-center ${form.role === value ? 'border-primary bg-primary' : 'border-gray-300'}`}>
//                         {form.role === value && <div className="w-2 h-2 rounded-full bg-white" />}
//                       </div>
//                     </div>
//                   </button>
//                 ))}
...
//                 <input name="password" type="password" value={form.password} onChange={handleChange} placeholder="Min 8 chars, uppercase & number" className="input-field" />
//               </div>
...
//                   {loading ? <span className="w-5 h-5 border-2 border-white/40 border-t-white rounded-full animate-spin" /> : 'Register'}
//                 </button>
//               </div>
//             </form>
//           )}
