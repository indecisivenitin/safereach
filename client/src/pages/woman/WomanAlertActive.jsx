...
//             <div
//               key={idx}
//               className={`h-1.5 flex-1 rounded-full transition-all ${STATUS_STEPS.indexOf(currentStep) >= idx
//                   ? 'bg-white'
//                   : 'bg-white/30'
//                 }`}
//             />
...
//             <p className="text-xs uppercase tracking-wide text-gray-400 font-bold mb-4">
//               Volunteer Details
//             </p>
...
export default function WomanAlertActive() {
  ...
  if (
    Array.isArray(volunteerLocation) &&
    volunteerLocation.length === 2 &&
    volunteerLocation[0] !== undefined &&
    volunteerLocation[1] !== undefined
  ) {
